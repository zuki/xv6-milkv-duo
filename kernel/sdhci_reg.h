// duo-buildroot-sdk/u-boot-2021.10/board/cvitek/cv180x/sdhci_reg.h
...
#define SDHCI_PHY_CONFIG        (CVI_SDHCI_VENDOR_OFFSET + 0x4C) // P_VERDOR_SPECIFIC_AREA + 0x4c0x24c( PHY_TX_BPS )
