...
#define PINMUX_BASE     (MMIO_BASE + 0x1000)
#define CLKGEN_BASE     0x03002000
#define RESET_BASE      0x03003000
#define WATCHDOG_BASE   (MMIO_BASE + 0x00010000)
 ...
 */
#define GP_REG0     (MMIO_BASE + 0x80)
#define GP_REG1     (MMIO_BASE + 0x84)
#define GP_REG2     (MMIO_BASE + 0x88)
#define GP_REG3     (MMIO_BASE + 0x8C)
#define GP_REG4     (MMIO_BASE + 0x90)
#define GP_REG5     (MMIO_BASE + 0x94)
#define GP_REG6     (MMIO_BASE + 0x98)
#define GP_REG7     (MMIO_BASE + 0x9C)
#define GP_REG8     (MMIO_BASE + 0xA0)
#define GP_REG9     (MMIO_BASE + 0xA4)
#define GP_REG10    (MMIO_BASE + 0xA8)
...
#define REG_TOP_USB_ECO             (MMIO_BASE + 0xB4)
...
#define REG_TOP_USB_CTRSTS      (MMIO_BASE + 0x38)

#define REG_TOP_CONF_INFO               (MMIO_BASE + 0x4)
#define BIT_TOP_CONF_INFO_VBUS          BIT(9)
#define REG_TOP_USB_PHY_CTRL            (MMIO_BASE + 0x48)
#define BIT_TOP_USB_PHY_CTRL_EXTVBUS    BIT(0)
#define USB_PHY_ID_OVERRIDE_ENABLE      BIT(6)
#define USB_PHY_ID_VALUE                BIT(7)
#define REG_TOP_DDR_ADDR_MODE           (MMIO_BASE + 0x64)
...
/* eFuse  */
#define EFUSE_BASE (MMIO_BASE + 0x00050000)
