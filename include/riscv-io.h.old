 ...
 *
 */
#ifndef INC_RISCV_IO_H
#define INC_RISCV_IO_H
...
static inline void writeb(uint8_t val, volatile void __iomem *addr)
{
    __iowmb();
    __arch_putb(val, addr);
}

static inline void writew(uint16_t val, volatile void __iomem *addr)
{
    __iowmb();
...
static inline void writeq(uint64_t val, volatile void __iomem *addr)
{
    __iowmb();
